...
import 'package:scheduler/notifications/notifications_alarm_manager.dart';
import 'package:scheduler/screens/create_case_screen.dart';
                ...
                onTap: () async {
                  ...
                  if (time != null) {
                    ...
                    await prefs.setString(
                        'notificationTime', time.format(context));
